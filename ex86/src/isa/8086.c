...
EX86_INSTRUCTION(add8_m_i) {
    EX86_REGISTER_8_SET(dest.r, EX86_MEMORY_8_GET(dest.p) + EX86_IMMEDIATE_8(dest.p));
}
EX86_INSTRUCTION(add8_r_r) {
    EX86_REGISTER_8_SET(dest.r, EX86_REGISTER_8_GET(dest.r) + EX86_REGISTER_8(src.r));
}
